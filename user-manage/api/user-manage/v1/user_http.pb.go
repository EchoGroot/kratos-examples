...
const OperationUserServiceCreateUser = "/usermanage.admin.v1.UserService/CreateUser"
const OperationUserServiceDeleteUser = "/usermanage.admin.v1.UserService/DeleteUser"
const OperationUserServiceGetUser = "/usermanage.admin.v1.UserService/GetUser"
const OperationUserServiceListUsers = "/usermanage.admin.v1.UserService/ListUsers"
const OperationUserServiceUpdateUser = "/usermanage.admin.v1.UserService/UpdateUser"
...
func RegisterUserServiceHTTPServer(s *http.Server, srv UserServiceHTTPServer) {
	...
	r.PATCH("/v1/users/{user.id}", _UserService_UpdateUser0_HTTP_Handler(srv))
	r.PUT("/v1/users/{user.id}", _UserService_UpdateUser1_HTTP_Handler(srv))
